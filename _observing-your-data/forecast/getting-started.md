...
For more information, see the blog post [Improving Anomaly Detection: One Million Entities in One Minute](https://magiccreative.io/blog/one-million-enitities-in-one-minute/). Although focused on anomaly detection, the recommendations apply to forecasting, as both features share the same underlying Random Cut Forest (RCF) model.
