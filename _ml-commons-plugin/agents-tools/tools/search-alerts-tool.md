...
SmartObserve responds with a list of generated alerts and the total number of alerts:
...
If no alerts are found, SmartObserve responds with an empty array in the results:
