...
MCdesk responds with a list of generated alerts and the total number of alerts:
...
If no alerts are found, MCdesk responds with an empty array in the results:
