...
To set up a cluster with a dedicated ML node, see the sample [Docker compose file](https://github.com/igsl-group/ml-commons/blob/main/docs/docker/docker-compose.yml).
