...
If the model was registered using the [Amazon Bedrock AI21 Labs Jurassic blueprint](https://github.com/igsl-group/ml-commons/blob/2.x/docs/remote_inference_blueprints/bedrock_connector_ai21labs_jurassic_blueprint.md), a default interface is applied automatically.
{: .note}
