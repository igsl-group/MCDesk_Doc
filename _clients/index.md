...
If you test a legacy client and verify that it works, please [submit a PR](https://github.com/igsl-group/documentation-website/pulls) and add it to this table.
