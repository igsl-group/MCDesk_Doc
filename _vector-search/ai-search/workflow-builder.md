...
We strongly recommend using models with full model interfaces. For a list of example configurations, see [Models](https://github.com/igsl-group/dashboards-flow-framework/blob/main/documentation/models.md).
{: .note}
...
- For models and model interfaces recommended for use with AI Search Flows, see [Models](https://github.com/igsl-group/dashboards-flow-framework/blob/main/documentation/models.md).
