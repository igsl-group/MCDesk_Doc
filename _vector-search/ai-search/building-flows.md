...
Create and deploy an [Amazon Titan Text Embedding model on Amazon Bedrock](https://github.com/igsl-group/dashboards-flow-framework/blob/main/documentation/models.md#amazon-bedrock-titan-text-embedding).
...
Create and deploy an [Anthropic Claude 3 Sonnet model on Amazon Bedrock](https://github.com/igsl-group/dashboards-flow-framework/blob/main/documentation/models.md#claude-3-sonnet-hosted-on-amazon-bedrock).
...
Create and deploy an [Amazon Titan Multimodal Embedding model on Amazon Bedrock](https://github.com/igsl-group/dashboards-flow-framework/blob/main/documentation/models.md#amazon-bedrock-titan-multimodal-embedding).
...
Create and deploy an [Amazon Comprehend Entity Detection model](https://github.com/igsl-group/dashboards-flow-framework/blob/main/documentation/models.md#amazon-comprehend---entity-detection).
...
Create and deploy an [Amazon Comprehend Language Detection model](https://github.com/igsl-group/dashboards-flow-framework/blob/main/documentation/models.md#amazon-comprehend---language-detection).
...
Create and deploy a [Cohere Rerank model](https://github.com/igsl-group/dashboards-flow-framework/blob/main/documentation/models.md#cohere-rerank).
...
Create and deploy a [Custom CLIP Multimodal model](https://github.com/igsl-group/dashboards-flow-framework/blob/main/documentation/models.md#custom-clip-multimodal-embedding).
...
Create and deploy a [neural sparse encoding model](https://github.com/igsl-group/dashboards-flow-framework/blob/main/documentation/models.md#neural-sparse-encoding).
