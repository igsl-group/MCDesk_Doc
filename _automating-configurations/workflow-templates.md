...
For all default parameter values for this workflow template, see [Cohere Embed semantic search defaults](https://github.com/igsl-group/flow-framework/blob/2.13/src/main/resources/defaults/cohere-embedding-semantic-search-defaults.json).
...
- [Defaults](https://github.com/igsl-group/flow-framework/blob/main/src/main/resources/defaults/bedrock-titan-embedding-defaults.json)
...
- **Required parameters**: 
  ...
  - `create_connector.credential.secret_key`
  - `create_connector.credential.session_token`
- [Defaults](https://github.com/igsl-group/flow-framework/blob/main/src/main/resources/defaults/bedrock-titan-multimodal-defaults.json)
...
- [Defaults](https://github.com/igsl-group/flow-framework/blob/main/src/main/resources/defaults/cohere-embedding-defaults.json)
...
- **Required parameters**: 
  - `create_connector.credential.key`
- [Defaults](https://github.com/igsl-group/flow-framework/blob/main/src/main/resources/defaults/cohere-chat-defaults.json)
...
- **Required parameters**: 
  - `create_connector.credential.key`
- [Defaults](https://github.com/igsl-group/flow-framework/blob/main/src/main/resources/defaults/openai-embedding-defaults.json)
...
- **Required parameters**: 
  - `create_connector.credential.key`
- [Defaults](https://github.com/igsl-group/flow-framework/blob/main/src/main/resources/defaults/openai-chat-defaults.json)
...
- [Defaults](https://github.com/igsl-group/flow-framework/blob/main/src/main/resources/defaults/semantic-search-defaults.json)
...
- **Required parameters**: 
  - `create_ingest_pipeline.model_id`: The model ID of the text embedding model to be used
- [Defaults](https://github.com/igsl-group/flow-framework/blob/main/src/main/resources/defaults/semantic-search-query-enricher-defaults.json)
...
- [Defaults](https://github.com/igsl-group/flow-framework/blob/main/src/main/resources/defaults/semantic-search-with-local-model-defaults.json)
...
- [Defaults](https://github.com/igsl-group/flow-framework/blob/main/src/main/resources/defaults/cohere-embedding-semantic-search-defaults.json)
...
- **Required parameters**:
  - `create_connector.credential.key`: API key for the Cohere model
- [Defaults](https://github.com/igsl-group/flow-framework/blob/main/src/main/resources/defaults/cohere-embedding-semantic-search-with-query-enricher-defaults.json)
...
- [Defaults](https://github.com/igsl-group/flow-framework/blob/main/src/main/resources/defaults/semantic-search-with-reindex-defaults.json)
...
- **Created components**: 
  ...
  - A vector index configured with the pipeline
- **Required parameters**: None
- [Defaults](https://github.com/igsl-group/flow-framework/blob/main/src/main/resources/defaults/local-sparse-search-biencoder-defaults.json)
...
- [Defaults](https://github.com/igsl-group/flow-framework/blob/main/src/main/resources/defaults/multi-modal-search-defaults.json)
...
- **Required parameters**:
  ...
  - `create_connector.credential.secret_key`
  - `create_connector.credential.session_token`
- [Defaults](https://github.com/igsl-group/flow-framework/blob/main/src/main/resources/defaults/multimodal-search-bedrock-titan-defaults.json)
...
- **Required parameters**: 
  - `create_ingest_pipeline.model_id`: The model ID of the text embedding model to be used
- [Defaults](https://github.com/igsl-group/flow-framework/blob/main/src/main/resources/defaults/hybrid-search-defaults.json)
...
- **Created components**:
  ...
  - A search pipeline with a `normalization_processor`
- **Required parameters**: None
- [Defaults](https://github.com/igsl-group/flow-framework/blob/main/src/main/resources/defaults/hybrid-search-with-local-model-defaults.json)
...
- [Defaults](https://github.com/igsl-group/flow-framework/blob/main/src/main/resources/defaults/conversational-search-defaults.json)
