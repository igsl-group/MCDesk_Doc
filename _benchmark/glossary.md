...
# SmartObserve Benchmark glossary

The following terms are commonly used in SmartObserve Benchmark:
...
- **Metric keys**: The metrics stored by SmartObserve Benchmark, based on the configuration in the [metrics record]({{site.url}}{{site.baseurl}}/benchmark/metrics/metric-records/).
