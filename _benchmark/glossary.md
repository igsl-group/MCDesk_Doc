...
# MCdesk Benchmark glossary

The following terms are commonly used in MCdesk Benchmark:
...
- **Metric keys**: The metrics stored by MCdesk Benchmark, based on the configuration in the [metrics record]({{site.url}}{{site.baseurl}}/benchmark/metrics/metric-records/).
