...
more_cards:
  - heading: "Concepts"
    description: "Learn core MCdesk Benchmark concepts"
  ...
  - heading: "Run and customize your workload"
    description: "Run and customize your MCdesk workload to get the most accurate results"
...
# MCdesk Benchmark User Guide

The MCdesk Benchmark User Guide includes core [concepts]({{site.url}}{{site.baseurl}}/benchmark/user-guide/concepts/), [installation]({{site.url}}{{site.baseurl}}/benchmark/installing-benchmark/) instructions, and [configuration options]({{site.url}}{{site.baseurl}}/benchmark/configuring-benchmark/) to help you get the most out of MCdesk Benchmark.
