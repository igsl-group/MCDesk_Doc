...
First, follow the [Amazon Bedrock Titan blueprint example](https://github.com/igsl-group/ml-commons/blob/2.x/docs/remote_inference_blueprints/bedrock_connector_titan_embedding_blueprint.md) to register and deploy the model. 
