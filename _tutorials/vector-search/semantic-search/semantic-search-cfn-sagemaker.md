...
For example, the Amazon Bedrock Titan embedding model ([blueprint](https://github.com/igsl-group/ml-commons/blob/2.x/docs/remote_inference_blueprints/bedrock_connector_titan_embedding_blueprint.md#2-create-connector-for-amazon-bedrock)) input is as follows:
