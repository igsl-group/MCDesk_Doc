...
:--- | :--- | :---
`query` | Object | A query in query domain-specific language (DSL). For a list of SmartObserve query types, see [Query DSL]({{site.url}}{{site.baseurl}}/smartobserve/query-dsl/). Required. 
