...
:--- | :--- | :---
`query` | Object | A query in query domain-specific language (DSL). For a list of MCdesk query types, see [Query DSL]({{site.url}}{{site.baseurl}}/mcdesk/query-dsl/). Required. 
