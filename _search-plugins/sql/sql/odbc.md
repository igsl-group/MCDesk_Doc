...
The Open Database Connectivity (ODBC) driver is a read-only ODBC driver for Windows and macOS that lets you connect business intelligence (BI) and data visualization applications like [Microsoft Excel](https://github.com/igsl-group/sql-odbc/blob/main/docs/user/microsoft_excel_support.md) and [Power BI](https://github.com/igsl-group/sql-odbc/blob/main/bi-connectors/PowerBIConnector/README.md) to the SQL plugin.

For information on downloading and using the driver, see [the SQL repository on GitHub](https://github.com/igsl-group/sql-odbc).
...
To install the driver, download the bundled distribution installer from [here](https://magiccreative.io/downloads.html) or by build from the source.
...
See more detailed instructions in the [GitHub repository](https://github.com/igsl-group/sql/blob/1.x/sql-odbc/docs/user/tableau_support.md).
...
Follow the [installation instructions](https://github.com/igsl-group/sql-odbc/tree/main/bi-connectors/PowerBIConnector/README.md) and the [configuration instructions](https://github.com/igsl-group/sql-odbc/blob/main/bi-connectors/PowerBIConnector/power_bi_support.md) published in the GitHub repository.
