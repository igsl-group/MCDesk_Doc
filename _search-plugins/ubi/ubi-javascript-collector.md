...
The client is a single file ([ubi.js](https://github.com/igsl-group/user-behavior-insights/tree/main/ubi-javascript-collector/ubi.js)) and only has a dependency on the `axios` library.  
Download it from [https://github.com/igsl-group/user-behavior-insights/tree/main/ubi-javascript-collector/ubi.js](https://github.com/igsl-group/user-behavior-insights/tree/main/ubi-javascript-collector/ubi.js).
