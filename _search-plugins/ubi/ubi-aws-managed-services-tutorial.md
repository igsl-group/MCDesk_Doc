...
1. Create two new indexes: `ubi_events` and `ubi_queries`.
    ...
    1. First, start creating the mappings for the `ubi_events` index:
        ...
        Open the [events-mapping.json](https://github.com/igsl-group/user-behavior-insights/blob/main/src/main/resources/events-mapping.json) file, copy its contents, and paste them after the `"mappings":` line:
    ...
    1. Next, create the `ubi_queries` index in a similar way. Set up the mappings:
        ...
        Open the [queries-mapping.json](https://github.com/igsl-group/user-behavior-insights/blob/main/src/main/resources/queries-mapping.json?utm_source=chatgpt.com) file, copy its contents, and paste them after the `"mappings":` line. Run the command and verify that it succeeds.
