...
To learn how to customize the source files, see [Updating the default dashboards](https://github.com/igsl-group/dashboards-search-relevance/blob/main/DEVELOPER_GUIDE.md#updating-default-dashboards).
