...
`format` | Optional | String | Specifies the format used to determine how SmartObserve defines and interprets synonyms. Valid values are:<br>- `solr` <br>- [`wordnet`](https://wordnet.princeton.edu/). <br> Default is `solr`.
