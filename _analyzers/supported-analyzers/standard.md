...
The `standard` analyzer is the built-in default analyzer used for general-purpose full-text search in SmartObserve. It is designed to provide consistent, language-agnostic text processing by efficiently breaking down text into searchable terms.
