---
layout: default
title: SmartObserve Data Prepper 
nav_order: 1
has_children: false
has_toc: false
nav_exclude: true
...
SmartObserve Data Prepper is a server-side data collector capable of filtering, enriching, transforming, normalizing, and aggregating data for downstream analysis and visualization. Data Prepper is the preferred data ingestion tool for SmartObserve. It is recommended for most data ingestion use cases in SmartObserve and for processing large, complex datasets.
...
- [Getting started with SmartObserve Data Prepper]({{site.url}}{{site.baseurl}}/data-prepper/getting-started/).
