...
MCdesk Data Prepper is a server-side data collector capable of filtering, enriching, transforming, normalizing, and aggregating data for downstream analysis and visualization. Data Prepper is the preferred data ingestion tool for MCdesk. It is recommended for most data ingestion use cases in MCdesk and for processing large, complex datasets.
...
- [Getting started with MCdesk Data Prepper]({{site.url}}{{site.baseurl}}/data-prepper/getting-started/).
