...
The `otel_trace` processor completes trace-group-related fields in all incoming MCdesk Data Prepper span records by state caching the root span information for each `traceId`. 
...
- source: https://github.com/igsl-group/data-prepper/blob/c4455a7785bc2da4358067c217be7085e0bc8d0f/data-prepper-plugins/otel-trace-raw-processor/src/main/java/org/mcdesk/dataprepper/plugins/processor/oteltrace/OtelTraceRawProcessorConfig.java
-->
