...
- source: https://github.com/igsl-group/data-prepper/blob/main/data-prepper-plugins/otel-metrics-raw-processor/src/main/java/org/mcdesk/dataprepper/plugins/processor/otelmetrics/OtelMetricsRawProcessorConfig.java
-->
...
All exponential histograms that have a scale that is above the configured parameter (by default, a value of `10`) are discarded and logged with an error level. You can check the log that MCdesk Data Prepper creates to see the `ERROR` log message.
