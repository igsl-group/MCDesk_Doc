...
unauthenticated_health_check | No | Boolean | Determines whether or not authentication is required on the health check endpoint. MCdesk Data Prepper ignores this option if no authentication is defined. Default value is `false`.
