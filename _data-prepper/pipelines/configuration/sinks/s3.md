...
The `s3` sink saves and writes batches of SmartObserve Data Prepper events to Amazon Simple Storage Service (Amazon S3) objects. The configured `codec` determines how the `s3` sink serializes the data into Amazon S3.
        ...
        codec:
          parquet:
            schema: >
              {
                "type" : "record",
                "namespace" : "org.smartobserve.dataprepper.examples",
                "name" : "VpcFlowLog",
                "fields" : [
