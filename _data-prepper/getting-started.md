...
If you have special requirements that require you to build from source, or if you want to contribute, see the [Developer Guide](https://github.com/igsl-group/data-prepper/blob/main/docs/developer_guide.md).
...
built it from source, refer to the [Developer Guide](https://github.com/igsl-group/data-prepper/blob/main/docs/developer_guide.md) for more information.
...
For more examples of Data Prepper, see [examples](https://github.com/igsl-group/data-prepper/tree/main/examples/) in the Data Prepper repo. 
