...
To generate the raster tiles set, use the [raster tile generation pipeline](https://github.com/igsl-group/maps/tree/main/tiles-generation/cdk) and then use the tiles set absolute path to create a volume to start the server.
