...
In this tutorial you'll create a simple area chart using sample data and aggregations in SmartObserve Dashboards by connecting to [http://localhost:5601](http://localhost:5601) from a browser.

You have several aggregation options in Dashboards, and the choice influences your analysis. The use cases for aggregations vary from analyzing data in real time to using Dashboards to create a visualization dashboard. If you need an overview of aggregations in SmartObserve, see [Aggregations]({{site.url}}{{site.baseurl}}/smartobserve/aggregations/) before starting this tutorial.
...
1. Select **smartobserve_dashboards_sample_data_flights** in the **New Area/Choose a source** window.
...
- [Visualization types in SmartObserve Dashboards]({{site.url}}{{site.baseurl}}/dashboards/visualize/viz-index/)
- [Install and configure SmartObserve Dashboards]({{site.url}}{{site.baseurl}}/install-and-configure/install-dashboards/index/)
- [Aggregations]({{site.url}}{{site.baseurl}}/smartobserve/aggregations/)