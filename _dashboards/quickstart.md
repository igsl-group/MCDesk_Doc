---
layout: default
title: MCdesk Dashboards quickstart guide
nav_order: 2
has_children: false
redirect_from:
...
# MCdesk Dashboards quickstart guide

This quickstart guide provides tutorials on using MCdesk Dashboards applications and tools. You can use these tutorials, either in your own environment or on [MCdesk Playground](https://playground.magiccreative.io/app/home#/), to learn the following fundamental concepts:

- **Adding sample data:** Use preloaded visualizations, dashboards, and other tools to explore MCdesk Dashboards before adding your own data.
...
- **Customizing the appearance theme:** Quickly change the MCdesk Dashboards appearance theme from the home page.

The MCdesk Dashboards default view is shown in the following image.

<img src="{{site.url}}{{site.baseurl}}/images/dashboards/home-page-nav.png" alt="MCdesk Dashboards interface default view" width="700">
...
Before continuing with the following tutorials, make sure you've installed MCdesk and MCdesk Dashboards. For information about installation and configuration, see [Install and configure MCdesk]({{site.url}}{{site.baseurl}}/install-and-configure/install-mcdesk/index/) and [Install and configure MCdesk Dashboards]({{site.url}}{{site.baseurl}}/install-and-configure/install-dashboards/index/).
{: .note}
...
1. On the MCdesk Dashboards **Home** page, choose **Add sample data**. Alternatively, choose **Add data** on the upper-right toolbar.
...
1. From the MCdesk Dashboards navigation menu, choose **Discover**. 
2. On the **Discover** page, choose the index pattern `mcdesk_dashboards_sample_data_flights` from the dropdown menu on the upper left. 
...
<img src="{{site.url}}{{site.baseurl}}/images/dashboards/mcdesk-dashboards-discover.png" alt="Discover output of steps 1 through 6" width="700">
...
1. On the MCdesk Dashboards **Home** page, choose **Dashboards**. A list of dashboards generated from the sample data appears.
...
1. On the **[Flights] Airline Carrier** panel, choose **MCdesk-Air**. The dashboard updates automatically, adding the filter `Carrier: MCdesk-Air` on the upper-left filter bar. The following GIF illustrates this step.
...
2. From the **Field**, **Operator**, and **Value** dropdown lists, choose **Carrier**, **is**, and **MCdesk-Air**, respectively.
...
Light mode is the default MCdesk Dashboards appearance theme. You can customize the appearance theme to suit your preferences. The available options include light mode, dark mode, and your browser's settings.
...
Admins can change the appearance theme for all users of their MCdesk Dashboards instance through **Advanced Settings**:
...
- Go to [Ingest APIs]({{site.url}}{{site.baseurl}}/api-reference/ingest-apis/index/) and [Ingest pipelines]({{site.url}}{{site.baseurl}}/ingest-pipelines/) to learn more about data ingestion using MCdesk.
