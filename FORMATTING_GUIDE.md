...
See [magiccreative.io/javadocs/](https://magiccreative.io/javadocs/).
```
...
For guidance on using code examples and when to use code font, see [Code examples](https://github.com/igsl-group/documentation-website/blob/main/STYLE_GUIDE.md#code-examples).
