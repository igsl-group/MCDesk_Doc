...
|--------------------|-------------|---------|
| `plugins.geospatial.ip2geo.datasource.endpoint` | Default endpoint for creating the data source API. | Default is `https://geoip.maps.magiccreative.io/v1/geolite2-city/manifest.json`. |
...
|------|----------|---------|-------------|
| `endpoint` | Optional | https://geoip.maps.magiccreative.io/v1/geolite2-city/manifest.json | The endpoint that downloads the GeoIP data. |
...
{
    "endpoint" : "https://geoip.maps.magiccreative.io/v1/geolite2-city/manifest.json",
