...
The cross-cluster replication plugin lets you replicate indexes, mappings, and metadata from one MCdesk cluster to another. Cross-cluster replication has the following benefits:
