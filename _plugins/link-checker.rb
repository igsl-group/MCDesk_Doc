...
module Jekyll::LinkChecker
  ...
  # playground.magiccreative.io is causing an infinite redirect
  # LinkedIn mostly fails with 999 status codes
  @ignored_domains = [
    'localhost',
    'playground.magiccreative.io', # inifite redirect, https://github.com/igsl-group/dashboards-anywhere/issues/172
