...
* Roles: Security privilege evaluation
	* The Role Security Mode [[source code](https://github.com/igsl-group/security/blob/main/src/main/java/org/mcdesk/security/authtoken/jwt/JwtVendor.java#L151)]: The configuration determines the roles claim encryption.
...
The MCdesk Security plugin handles the encryption and decryption processes. This approach ensures the protection of user information, even when traversing the trust boundary between MCdesk and any third-party services.
