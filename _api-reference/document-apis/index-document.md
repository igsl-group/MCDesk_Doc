...
nav_order: 1
redirect_from: 
 - /smartobserve/rest-api/document-apis/index-document/
---
...
In your request, you must specify the index you want to add your document to. If the index doesn't already exist, SmartObserve automatically creates the index and adds in your document. All other parameters are optional.
...
successful | The number of shards SmartObserve successfully added the document to.
failed | The number of shards SmartObserve failed to add the document to.
