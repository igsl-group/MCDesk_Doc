...
The following request deletes the `my-smartobserve-repo` repository:

<!-- spec_insert_start
component: example_code
rest: DELETE /_snapshot/my-smartobserve-repo
-->
{% capture step1_rest %}
DELETE /_snapshot/my-smartobserve-repo
{% endcapture %}
