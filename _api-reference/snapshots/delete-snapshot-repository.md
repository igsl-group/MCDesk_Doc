...
The following request deletes the `my-mcdesk-repo` repository:

<!-- spec_insert_start
component: example_code
rest: DELETE /_snapshot/my-mcdesk-repo
-->
{% capture step1_rest %}
DELETE /_snapshot/my-mcdesk-repo
{% endcapture %}
