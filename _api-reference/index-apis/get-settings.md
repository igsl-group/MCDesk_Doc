...
nav_order: 95
redirect_from:
  - /smartobserve/rest-api/index-apis/get-settings/
...
include_defaults | Boolean | Whether to include default settings, including settings used within SmartObserve plugins, in the response. Default is `false`.
