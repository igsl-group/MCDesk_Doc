...
nav_order: 95
redirect_from:
  - /mcdesk/rest-api/index-apis/get-settings/
...
include_defaults | Boolean | Whether to include default settings, including settings used within MCdesk plugins, in the response. Default is `false`.
