...
`bytes` | Byte units | [Units]({{site.url}}{{site.baseurl}}/mcdesk/units/) used to display byte size values.
...
`time` | Time units | [Units]({{site.url}}{{site.baseurl}}/mcdesk/units/) used to display time values.
