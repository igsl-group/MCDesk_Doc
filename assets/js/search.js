    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        const doSearch = async () => {
            ...
            try {
                ...
                const response = await fetch(`https://search-api.magiccreative.io/search?q=${query}&v=${docsVersion}`, { signal: controller.signal });
...
window.doResultsPageSearch = async (query, type, version) => {
    ...
    try {
        ...
        const response = await fetch(`https://search-api.magiccreative.io/search?q=${query}&v=${version}&t=${type}`);
        const data = await response.json();
